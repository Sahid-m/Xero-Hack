...
import { shouldResubmitForToolApproval } from "@/lib/chat-auto-send";
...
function VocaChatInner({
  ...
  const {
    ...
    transport,
    sendAutomaticallyWhen: shouldResubmitForToolApproval,
          ...
          <div className="mx-auto mb-2 max-w-2xl rounded-xl border border-red-500/25 bg-red-500/10 px-4 py-2.5 text-sm text-red-300">
            <div className="flex items-start justify-between gap-3">
              ...
              <button
                type="button"
                onClick={clearError}
                className="shrink-0 text-xs text-red-200/80 hover:text-red-100"
              >
                Dismiss
              </button>
            </div>
